> SUPERSEDED by `docs/superpowers/plans/2026-06-08-eval-set-gen.md` — historical, retained for lineage. The current version is canonical; canon facts: `docs/GROUND_TRUTH.md`.
